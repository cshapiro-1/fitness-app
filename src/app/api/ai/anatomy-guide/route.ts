...
const ANATOMY_CHARTS: Record<string, AnatomyGuideData> = {
  ...
  front_squat: {
    image: "/anatomy/squat.jpg",
    title: "Barbell Front Squat (Anterior Chain & Quad Isolation)",
    primaryMuscles: ["Quadriceps Femoris (Vastus Medialis Teardrop, Vastus Lateralis)", "Thoracic Erector Spinae"],
    secondaryMuscles: ["Gluteus Maximus", "Adductor Magnus", "Rectus Abdominis / Core", "Anterior Deltoids"],
    biomechanicsCue: "Keep elbows pointed high and parallel to floor. Maintain an upright vertical torso so knees travel forward over toes to isolate the anterior quadriceps.",
    steps: [
      "Set Up: Rest barbell across anterior deltoids and clavicles with clean grip fingertips or cross-arm grip.",
      "Descent: Break at knees and hips with proud upright chest, dropping straight down into the hole.",
      "Ascent: Drive straight up through mid-foot while aggressively fighting to keep elbows elevated.",
    ],
    commonMistakes: [
      "Elbows dropping downward causing thoracic collapse and forward bar dumping.",
      "Hinging backward like a back squat instead of squatting vertically between knees.",
    ],
    breathingPattern: "Inhale deeply into abdomen at top → Hold intra-abdominal brace through bottom → Exhale past sticking point.",
  },
  goblet_squat: {
    image: "/anatomy/squat.jpg",
    title: "Goblet Squat (Dumbbell & Kettlebell)",
    ...
    biomechanicsCue: "Hold dumbbell vertically against upper chest. Track elbows inside knees at the bottom to open hips and maximize quad recruitment.",
    steps: [
      "Set Up: Cup top of dumbbell with both hands against chest, feet shoulder-width with toes angled outward.",
      "Descent: Squat deeply between knees, letting elbows track smoothly inside inner thighs.",
      "Drive: Pause for 1 count in deep flexion, then press floor away through heels and mid-foot.",
    ],
    commonMistakes: [
      "Holding weight away from chest, increasing lumbar fatigue.",
      "Rounding the upper thoracic spine at bottom depth.",
    ],
    breathingPattern: "Inhale on descent → Exhale as you drive through floor to standing.",
  },
  box_squat: {
    image: "/anatomy/squat.jpg",
    title: "Box Squat (Posterior Chain & Rate of Force Development)",
    ...
    biomechanicsCue: "Sit back deliberately onto the box without rocking torso or relaxing core tension. Pause for 1 full second, then explode upward.",
    steps: [
      "Set Up: Position box at parallel depth behind squat stance.",
      "Sit: Hinge hips back and descend under control until fully seated on box.",
      "Pause & Explode: Pause 1 count without rocking back, then drive hips forward explosively.",
    ],
    commonMistakes: [
      "Crashing down hard onto the box.",
      "Rocking backward and forward to generate momentum.",
    ],
    breathingPattern: "Inhale at top → Maintain brace while paused on box → Exhale on explosive ascent.",
  },
  hack_squat: {
    image: "/anatomy/squat.jpg",
    title: "Hack Squat & Leg Press Machine",
    ...
    biomechanicsCue: "Keep lower back and pelvis pinned flat against backrest throughout. Descend to at least 90° knee angle without tailbone peeling off pad.",
    steps: [
      "Set Up: Shoulders under pads, back flat against pad, feet shoulder-width mid-platform.",
      "Descent: Release safety handles and lower carriage smoothly to full comfortable knee flexion.",
      "Ascent: Drive platform away through full foot until knees reach terminal extension without hard lockout.",
    ],
    commonMistakes: [
      "Lower back rolling off backrest at bottom of range.",
      "Placing feet too high on platform (turns hack squat into a glute bridge).",
    ],
    breathingPattern: "Inhale as carriage descends → Exhale forcefully as you press upward.",
  },
  bench: {
  ...
  sumo_deadlift: {
    image: "/anatomy/deadlift.jpg",
    title: "Sumo Barbell Deadlift (Glute & Adductor Emphasis)",
    primaryMuscles: ["Gluteus Maximus", "Adductor Magnus (Inner Thigh)", "Quadriceps Femoris"],
    secondaryMuscles: ["Hamstrings", "Erector Spinae", "Trapezius", "Forearms (Grip)"],
    biomechanicsCue: "Wide stance with toes angled 45° out. Maintain a vertical torso with hips close to the bar, and push the floor apart laterally with feet on the drive.",
    steps: [
      "Set Up: Stand with wide stance, shins touching knurling inside the barbell rings.",
      "Wedge & Grip: Grip bar directly under shoulders inside knees with tall proud chest.",
      "Drive: Push floor apart laterally, driving hips through into explosive glute lockout.",
    ],
    commonMistakes: [
      "Hips rising before chest (stripper pull).",
  ...
  romanian_deadlift: {
    image: "/anatomy/deadlift.jpg",
    title: "Romanian Deadlift (RDL - Barbell & Dumbbell)",
    primaryMuscles: ["Hamstrings (Biceps Femoris, Semitendinosus, Semimembranosus)", "Gluteus Maximus"],
    secondaryMuscles: ["Erector Spinae", "Adductor Magnus", "Latissimus Dorsi", "Forearms"],
    biomechanicsCue: "Maintain fixed soft knee bend (15-20°). Push hips backward like shutting a car door with glutes until hamstrings reach peak stretch at mid-shin.",
    steps: [
      "Set Up: Stand tall with feet hip-width apart, shoulders packed and core braced.",
      "Hinge: Push pelvis straight backward while keeping bar glued against thighs.",
      "Lower & Squeeze: Stop when hips cannot travel further back (mid-shin), then drive hips forward squeezing glutes.",
    ],
    commonMistakes: [
      "Bending knees excessively into a squat.",
      "Allowing bar to drift away from thighs (places high shear on lumbar spine).",
      "Rounding lower back to fake extra depth.",
    ],
    breathingPattern: "Inhale & brace at top → 3-second eccentric stretch on descent → Exhale as hips extend forward.",
  },
  trap_bar_deadlift: {
    image: "/anatomy/deadlift.jpg",
    title: "Trap Bar Deadlift (Hex Bar - Quadriceps & Posterior Chain)",
    primaryMuscles: ["Quadriceps Femoris", "Gluteus Maximus", "Erector Spinae"],
    secondaryMuscles: ["Hamstrings", "Trapezius", "Forearms (Grip)", "Transverse Abdominis"],
    biomechanicsCue: "Neutral grip aligns resistance directly through center of mass, maximizing leg drive with reduced spinal shear.",
    steps: [
      "Set Up: Step inside hex bar with feet hip-width apart.",
      "Grip: Hinge down and grip neutral side handles firmly with flat spine.",
      "Drive: Push floor away through full foot and stand tall into full lockout.",
    ],
    commonMistakes: [
